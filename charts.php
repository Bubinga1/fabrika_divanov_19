...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
            ...
            <div id="layoutSidenav_content">
                <main>
                    <div class="container-fluid px-4">
                        <h1 class="mt-4">Метрика</h1>
                        <ol class="breadcrumb mb-4">
                            <li class="breadcrumb-item"><a href="MainAdmin.php">Главная</a></li>
                            <li class="breadcrumb-item active">Метрика</li>
                        </ol>
                        <!-- <div class="card mb-4">
                            <div class="card-body">
        ...
        <script src="app\Admin\assets\demo\chart-area-demo.js"></script>
        <script src="app\Admin\assets\demo\chart-bar-demo.js"></script>
        <script src="https://cdn.jsdelivr.net/npm/simple-datatables@7.1.2/dist/umd/simple-datatables.min.js" crossorigin="anonymous"></script>
        <script src="app\Admin\js\datatables-simple-demo.js"></script>
        <script src="app\Admin\assets\demo\chart-pie-demo.js"></script>
    </body>
</html>
